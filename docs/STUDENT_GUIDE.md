...
Також є **повністю розв'язаний варіант 30** — `lr1/variants/v30/`. Це приклад того, як має виглядати виконана лабораторна: `http://localhost:8000/lr1/variants/v30/`
...
4. Створіть файли у папці `lr1/` відповідно до завдання
...
├── task2.php       ← ваш код (завдання 1)
├── task3.php       ← ваш код (завдання 2)
├── task4.php       ← ваш код (завдання 3)
└── ...
```

> Структуру файлів беріть з demo/ — називайте файли так само.
...
Відкрийте: `http://localhost:8000/lr1/task2.php`
...
4. Подивись demo/               (приклад)
5. Напиши код
6. Перевір у браузері
7. git add файл.php
8. git commit -m "feat: taskN - опис"
9. git push -u origin lrN
```
...
- Файли вашого варіанту створюйте **в папці лаби** (не в demo/, не в variants/)
...
│   ├── task2.php    # ← ТУТ ваш код
│   └── task3.php    # ← ТУТ ваш код
