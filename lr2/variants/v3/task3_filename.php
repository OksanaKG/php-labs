 ...
 *
 * Варіант 3: "E:\Photos\Vacation\sunset.jpg"
 */
...
$path = $_POST['path'] ?? 'E:\Photos\Vacation\sunset.jpg';
...
<div class="demo-card">
    ...
    <form method="post" class="demo-form">
        <div>
            ...
            <input type="text" id="path" name="path" value="<?= htmlspecialchars($path) ?>" placeholder="E:\Photos\Vacation\sunset.jpg">
        </div>
