 ...
 *
 * Варіант 3: логін "vovk_marta", міста, cookie (мова), завантаження фото
 * POST, сесія, клієнтська валідація та серверна валідація
 */
session_start();
...
// Для автозаповнення
$formData = [
    'login' => $_POST['login'] ?? $sessionData['login'] ?? 'vovk_marta',
