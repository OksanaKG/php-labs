...
<form method="POST" action="index.php?route=auth/register" class="form">
    ...
    <div class="form__group">
        <label for="reg_gender" class="form__label">Стать</label>
        <select id="reg_gender" name="gender" class="form__input">
            <option value="">Оберіть стать</option>
            <option value="male" <?= ($old['gender'] ?? '') === 'male' ? 'selected' : '' ?>>Чоловіча</option>
            <option value="female" <?= ($old['gender'] ?? '') === 'female' ? 'selected' : '' ?>>Жіноча</option>
        </select>
    </div>
